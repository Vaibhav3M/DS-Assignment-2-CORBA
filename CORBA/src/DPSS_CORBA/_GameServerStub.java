...
/**
* DPSS_CORBA/_GameServerStub.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from DPSS-CORBA.idl
* Tuesday, June 23, 2020 8:00:45 o'clock PM EDT
*/

public class _GameServerStub extends org.omg.CORBA.portable.ObjectImpl implements DPSS_CORBA.GameServer
{
  ...
  public String getPlayerStatus (String AdminUsername, String AdminPassword, String IPAddress, boolean checkOtherServers)
  {
            ...
            try {
                ...
                $out.write_string (IPAddress);
                $out.write_boolean (checkOtherServers);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                ...
                return getPlayerStatus (AdminUsername, AdminPassword, IPAddress, checkOtherServers        );
            } finally {
                _releaseReply ($in);
            }
  } // getPlayerStatus
